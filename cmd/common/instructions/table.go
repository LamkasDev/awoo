...
func SetupInstructionTableEntry(table AwooInstructionTable, instruction instruction.AwooInstructionDefinition, process interface{}) {
...
func DecorateInstructionTableEntry(table AwooInstructionTable, code uint8, arg uint16, process interface{}) {
